...
@pytest.mark.parametrize('data_set,model,sk_model,min_accuracy_compared_to_sk,min_abs_accuracy_diff', [
    ...
    (osmld.ExamDataSet('data/exam/ex4x.dat', 'data/exam/ex4y.dat'),
        osmlm.KNearestNeighborsClassification(), sknn.KNeighborsClassifier(n_neighbors=7, weights='distance'), .7, .1),
    ...
    (osmld.MushroomDataSet('data/mushroom/mushroom.csv'), osmlm.DecisionTreeClassification(),
        skt.DecisionTreeClassifier(), .85, .05),
    (osmld.TitanicDataSet('data/titanic/titanic.csv'), osmlm.DecisionTreeClassification(),
        skt.DecisionTreeClassifier(), .85, .05),
    (osmld.IrisDataSet('data/iris/iris.csv'), osmlm.DecisionTreeClassification(), skt.DecisionTreeClassifier(), .8,
        .05),
